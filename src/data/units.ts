...
export const units: Unit[] = [
  ...
  },
  {
    ...
    conversation: [c('u2-1', '自己紹介', '你叫什么名字？', 'お名前は？', 1), c('u2-2', '自己紹介', '我叫美香。', 'わたしは美香です。', 1)],
    gameType: 'memory', isTest: false, stars: 1
  },
  {
    ...
    conversation: [c('u3-1', '出身', '你是哪里人？', 'どこの人ですか？', 1), c('u3-2', '出身', '我是日本人。', 'わたしは日本人です。', 1)],
  ...
  },
  {
    ...
    conversation: [c('u4-1', '年齢', '你几岁？', '何歳ですか？', 1), c('u4-2', '年齢', '我九岁。', 'わたしは9歳です。', 1), c('u4-3', '年齢', '我十二岁。', 'わたしは12歳です。', 1)],
  ...
  },
  {
    ...
    conversation: [c('u5-1', 'テスト', '你叫什么名字？', 'お名前は？', 1), c('u5-2', 'テスト', '我是日本人。', 'わたしは日本人です。', 1)],
  ...
  },
  {
    ...
    conversation: [c('u6-1', '家族', '这是我妈妈。', 'これはわたしのママです。', 2), c('u6-2', '家族', '你有哥哥吗？', 'お兄さんはいますか？', 2)],
  ...
  },
  {
    ...
    conversation: [c('u7-1', '色', '你喜欢什么颜色？', 'どんな色が好き？', 2), c('u7-2', '色', '我喜欢粉色。', 'ピンクが好き。', 2)],
  ...
  },
  {
    ...
    conversation: [c('u8-1', '動物', '你喜欢什么动物？', 'どんな動物が好き？', 2), c('u8-2', '動物', '我喜欢猫。', 'わたしは猫が好き。', 2)],
  ...
  },
  {
    ...
    conversation: [c('u9-1', '食事', '你想吃什么？', '何を食べたい？', 2), c('u9-2', '食事', '我想吃饭。', 'ごはんを食べたい。', 2), c('u9-3', '食事', '好吃！', 'おいしい！', 2)],
  ...
  },
  {
    ...
    conversation: [c('u10-1', 'テスト', '你有哥哥吗？', 'お兄さんはいますか？', 2), c('u10-2', 'テスト', '我喜欢粉色。', 'ピンクが好き。', 2)],
  ...
  },
  {
    ...
    conversation: [c('u11-1', '天気', '今天天气怎么样？', '今日の天気はどう？', 2), c('u11-2', '天気', '今天很热。', '今日はとても暑い。', 2)],
    gameType: 'memory', isTest: false, stars: 2
  },
  {
    ...
    conversation: [c('u12-1', '買い物', '这个多少钱？', 'これはいくら？', 3), c('u12-2', '買い物', '太贵了！', '高すぎる！', 3), c('u12-3', '買い物', '便宜一点。', 'もう少し安く。', 3)],
  ...
  },
  {
    ...
    conversation: [c('u13-1', '道案内', '请问，学校在哪里？', 'すみません、学校はどこ？', 3), c('u13-2', '道案内', '往左走。', '左へ進んで。', 3)],
  ...
  },
  {
    ...
    conversation: [c('u14-1', '学校', '老师好！', '先生こんにちは！', 3), c('u14-2', '学校', '这是什么？', 'これは何？', 3), c('u14-3', '学校', '我不懂。', 'わかりません。', 3)],
  ...
  },
  {
    ...
    conversation: [c('u15-1', 'Boss', '你叫什么名字？', 'お名前は？', 3), c('u15-2', 'Boss', '这个多少钱？', 'これはいくら？', 3), c('u15-3', 'Boss', '请问，学校在哪里？', '学校はどこ？', 3)],
